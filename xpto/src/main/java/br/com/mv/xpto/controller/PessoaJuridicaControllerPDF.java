...
@Controller
@RequestMapping("/pj1")
public class PessoaJuridicaControllerPDF {
	...
	public ResponseEntity<byte[]> downloadInvoice() throws JRException, IOException {
		...
		JRBeanCollectionDataSource beanCollectionDataSource = new JRBeanCollectionDataSource(pjService.listarTodos());

		Map<String, Object> parameters = new HashMap<>();
		parameters.put("total", "7000");

		JasperReport compileReport = JasperCompileManager
				.compileReport(new FileInputStream("src/main/resources/pjRelatorio.jrxml"));
